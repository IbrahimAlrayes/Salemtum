                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          ...
                          <td>SAR <?php echo $data[$i][0]['item_price'] ?></td>
              ...
              <div class="col">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    for ($i = 0; $i < $num; $i++) {
                      if (isset($data[$i])) {
                    ?>
                        <strong class="text-black">SAR <?php echo ($data[$i][0]['item_price'] * $_SESSION['cart'][$i]['quantity']) ?></strong> <br>
                    <?php
                      }
                    }
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-6 text-right font-weight-bold">
                    <strong class="text-black">SAR <?php echo total_price($data); ?></strong>
                  </div>
                </div>
