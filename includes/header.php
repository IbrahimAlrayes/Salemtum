<div class="site-navbar py-2">
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            <div class="logo">
                <div class="site-logo">
                <a href="index.php"> <img src="images/sal.png" style="height: 80px; display: inline; padding-bottom: 5px; width:150px;"></a>
                    <!-- <a href="index.php" class="js-logo-clone">Salemtum</a> -->
                </div>
            </div>
